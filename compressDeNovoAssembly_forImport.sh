...
USAGE="USAGE: ./compressDeNovoAssembly_forImport.sh --targetFolder <path/to/assembly/output> --outputFolder <path/to/compressFileOutput> --prefix <name_for_output_file> [--gzip <force gzip output>] [--verbose <enable verbose output>]"
echo ""
