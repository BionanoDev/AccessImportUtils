...
USAGE="USAGE: ./compressHybridScaffold_forIrysViewImport.sh --targetFolder <path/to/hybrid/scaffold/output> --outputFolder <path/to/compressFileOutput> --prefix <name_for_output_file> [--gzip <force gzip output>] [--verbose <enable verbose output>]"
echo ""
